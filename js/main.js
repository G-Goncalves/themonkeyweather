...
function showPosition(position) {
  ...
  xmlhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("directVentoHoje").textContent = "Direcção do Vento: " + direcVentoHoje + "º";
      ...
      document.getElementById("directVentoAmanha").textContent = "Direcção do Vento: " + direcVentoAmanha + "º";
      ...
      document.getElementById("directVentoDepois").textContent = "Direcção do Vento: " + direcVentoDepois + "º";
